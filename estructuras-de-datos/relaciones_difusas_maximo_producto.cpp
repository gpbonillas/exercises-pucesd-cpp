...
void reldifusa(int fi1, int co1, int co2);
void mostrar_relacion(int fi1, int co2);
void imprimir(int fi1, int co1, int fi2, int co2);
...
void main()
{
 ...
 int fi1, co1, fi2, co2;
   do{
   clrscr();
   gotoxy(23,1);printf("RELACIONES DIFUSAS-MAXIMO PRODUCTO");
   ...
   imprimir(fi1,co1,fi2,co2);
   reldifusa(fi1,co1,co2);
   mostrar_relacion(fi1,co2);
...
x=45;
y=3;
gotoxy(49,1);printf("MATRIZ # 2: (%d x %d)",fi2,co2);
for(i=0;i<fi2;i++)
{
  for(j=0;j<co2;j++)
  {
