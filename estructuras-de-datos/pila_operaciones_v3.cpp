...
else
{
   do
   {
      ...
      aux= new nodo();
      imprimir_eliminar();
      gotoxy(1,1);cout<<"Ingrese el numero a insertar: ";cin>>num;
      gotoxy(1,2);cout<<"El numero "<<num<<" se insertara sobre..: ";cin>>n;
	...
	if(temp1->dato==n)
	{
      ...
      imprimir_eliminar();
      gotoxy(1,1);cout<<"¿DESEA INSERTA NUEVAMENTE?(s/n): ";cin>>opc4;
...
else
   {
	...
	cab=NULL;
	 ...
	 aux=aux->next;
        ...
        gotoxy(1,3);cout<<"Desea desapilar nuevamente: ";cin>>op5;
